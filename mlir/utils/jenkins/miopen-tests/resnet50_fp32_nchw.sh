...
# TODO bin/MIOpenDriver conv -F 1 -n 256 -c 3 -H 230 -W 230 -k 64 -y 7 -x 7 -p 0 -q 0 -u 2 -v 2 -l 1 -j 1 -m conv -g 1 -t 1
wait
} | grep OK -c | (read n ;
if [ $n != $a ]
then
...
#TODO bin/MIOpenDriver conv -F 4 -n 256 -c 3 -H 230 -W 230 -k 64 -y 7 -x 7 -p 0 -q 0 -u 2 -v 2 -l 1 -j 1 -m conv -g 1 -t 1
wait
} | grep OK -c | (read n ;
if [ $n != $a ]
then
